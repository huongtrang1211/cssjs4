...
jQuery(window).load(function() {
		if(document.cookie.indexOf("adf") == -1)
		{
			...
			jQuery("#myModal").html("<a href='https://www.facebook.com/Tragopvespatopcom/' target='_blank'><img src='http://topcom.com.vn/data/upload/resize2.jpg' width='500px'/><br/>mua xe vespa</a>. Liên Hệ 0977074628. <h2><a class='close-linhnguyen-modal'>X</a></h2>");
